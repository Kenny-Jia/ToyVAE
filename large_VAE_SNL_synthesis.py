...
model_path = 'VAE_40MHZ_model_Vlarge_onchip'
custom_objects = {
    'QDense': QDense,
...
#hls_config['Model']['Precision'] = 'ap_fixed<128,64>'
for layer in hls_config['LayerName'].keys():
    ...
    #if layer == 'inputs':
        #hls_config['LayerName'][layer]['Precision']['result'] = 'ap_fixed<64,32>'
    #if layer== 'BN0':
        #hls_config['LayerName'][layer]['Precision']['scale'] = 'ap_fixed<128,64>'
        #hls_config['LayerName'][layer]['Precision']['bias'] = 'ap_fixed<128,64>'
        #hls_config['LayerName'][layer]['Precision']['result'] = 'ap_fixed<40,16>'
    #if layer == 'dense1':
        #hls_config['LayerName'][layer]['Precision']['weight'] = 'ap_fixed<20,3>'
        #hls_config['LayerName'][layer]['Precision']['bias'] = 'ap_fixed<11,0>'
        #hls_config['LayerName'][layer]['Precision']['result'] = 'ap_fixed<40,16>'
    #if layer == "BN1":
        #hls_config['LayerName'][layer]['Precision']['scale'] = 'ap_fixed<32,16>'
        #hls_config['LayerName'][layer]['Precision']['result'] = 'ap_fixed<64,32>'
    #if layer == 'relu1':
        #hls_config['LayerName'][layer]['Precision']['result'] = 'ap_fixed<64,32,AP_RND_CONV,AP_SAT>'
        #hls_config['LayerName'][layer]['Precision']['result'] = 'ap_fixed<64,32>'
    #if layer == 'dense2':
        #hls_config['LayerName'][layer]['Precision']['weight'] = 'ap_fixed<20,3>'
        #hls_config['LayerName'][layer]['Precision']['bias'] = 'ap_fixed<11,0>'
...
cfg['OutputDir'] = 'test_large_SNL_VAE'
cfg['ClockPeriod'] = 25
...
def compare_anomaly_scores(signal_name, keras_predictions, hls_predictions):
    ...
    plt.tight_layout()
    plt.savefig(f'{signal_name}_difference_SNL.png')
    plt.close()
