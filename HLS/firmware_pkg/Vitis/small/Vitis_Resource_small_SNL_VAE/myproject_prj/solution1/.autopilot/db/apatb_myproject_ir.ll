; ModuleID = '/u1/hjia625/conifer/Vitis_Resource_small_SNL_VAE/myproject_prj/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a3struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.46"([3 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i32* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, i32* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, i32* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0.2" %src_2, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a3struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.43"([3 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i32* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.0" %src_0, i32* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.1" %src_1, i32* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0.2" %src_2) #3 {
entry:
  %0 = icmp eq [3 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a3struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.46"([3 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* nonnull %dst, i32* %src_0, i32* %src_1, i32* %src_2, i64 3)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse
define void @"arraycpy_hls.p0a57struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.56"(i1824* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, i64 %dst_shift, [57 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @"onebyonecpy_hls.p0a57struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.53"(i1824* noalias nocapture align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst, [57 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* noalias readonly "orig.arg.no"="1" "unpacked"="1" %src) #3 {
entry:
  %0 = icmp eq [57 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a57struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.56"(i1824* %dst, i64 0, [57 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* nonnull %src, i64 57)
  br label %ret
...
entry:
  call void @"onebyonecpy_hls.p0a57struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.53"(i1824* align 512 %1, [57 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* %0)
...
entry:
  ...
  call void @"onebyonecpy_hls.p0a3struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>.43"([3 x %"struct.ap_fixed<32, 16, AP_TRN, AP_WRAP, 0>"]* %2, i32* align 512 %_0, i32* align 512 %_1, i32* align 512 %_2)
  ret void
}
