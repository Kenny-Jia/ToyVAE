...
void myproject(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<dense1_weight_t, 7296>(w2, "w2.txt");
        nnet::load_weights_from_txt<dense1_bias_t, 128>(b2, "b2.txt");
        nnet::load_weights_from_txt<dense2_weight_t, 8192>(w5, "w5.txt");
        nnet::load_weights_from_txt<dense2_bias_t, 64>(b5, "b5.txt");
        nnet::load_weights_from_txt<z_mean_weight_t, 1024>(w8, "w8.txt");
        nnet::load_weights_from_txt<z_mean_bias_t, 16>(b8, "b8.txt");
        loaded_weights = true;
    }
#endif
